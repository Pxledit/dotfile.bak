...
pacman -S neofetch flameshot psmisc papirus-icon-theme mpv thunar-archive-plugin zsh pacman-contrib feh lxappearance papirus-icon-theme lxappearance fonts-noto-color-emoji sddm variety
